...
export interface PreferencesReducerState {
  ...
  progressionFormat?: RenditionObject<
    ThProgressionFormat | Array<ThProgressionFormat>
  >;
...
export const preferencesSlice = createSlice({
  ...
  reducers: {
    ...
    setRunningHeadFormat: (
      state,
      action: RenditionChangePayload<ThRunningHeadFormat>,
    ) => {
    ...
    updateFromPreferences(
      state,
      action: PayloadAction<ThPreferences<CustomizableKeys>>,
    ) {
