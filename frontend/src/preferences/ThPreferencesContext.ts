...
export const ThPreferencesContext =
  createContext<PreferencesContextValue<any> | null>(null);
...
export const defaultPreferencesContextValue: PreferencesContextValue<DefaultKeys> =
  {
    ...
    updatePreferences: () => {
      throw new Error(
        "updatePreferences must be used within a ThPreferencesProvider with an adapter",
      );
    },
  };
