...
export type CSSAbsoluteLength = CSSValueWithUnit<
  "cm" | "in" | "mm" | "pc" | "pt" | "px" | "Q"
>;

export type CSSAngle = CSSValueWithUnit<"deg" | "grad" | "rad" | "turn">;

export type CSSDefaultViewport = CSSValueWithUnit<
  "vb" | "vh" | "vi" | "vmax" | "vmin" | "vw"
>;

export type CSSDynamicViewport = CSSValueWithUnit<
  "dvb" | "dvh" | "dvi" | "dvmax" | "dvmin" | "dvw"
>;

export type CSSFrequency = CSSValueWithUnit<"Hz" | "kHz">;

export type CSSFontRelativeLength = CSSValueWithUnit<
  "cap" | "ch" | "em" | "ex" | "ic" | "lh"
>;

export type CSSLargeViewport = CSSValueWithUnit<
  "lvb" | "lvh" | "lvi" | "lvmax" | "lvmin" | "lvw"
>;

export type CSSPhysicalLength = CSSValueWithUnit<
  "cm" | "in" | "mm" | "pc" | "pt" | "Q"
>;

export type CSSRelativeLength =
  | CSSFontRelativeLength
  | CSSValueWithUnit<"%">
  | CSSRootFontRelativeLength;

export type CSSResolution = CSSValueWithUnit<"dpcm" | "dpi" | "dppx" | "x">;

export type CSSRootFontRelativeLength = CSSValueWithUnit<
  "rcap" | "rch" | "rem" | "rex" | "ric" | "rlh"
>;

export type CSSSmallViewport = CSSValueWithUnit<
