...
export const StatefulWordSpacing = ({
  standalone = true,
  ...
  const wordSpacingRangeConfig = {
    ...
    placeholder:
      preferences.settings.keys[ThSettingsKeys.wordSpacing].placeholder,
  ...
  const placeholderText = usePlaceholder(
    wordSpacingRangeConfig.placeholder,
    wordSpacingRangeConfig.range,
    "percent",
  );

  const { getSetting, submitPreferences } = useEpubNavigator();

  const { getEffectiveSpacingValue, setWordSpacing, canBeReset } =
    useSpacingPresets();
    ...
    <>
      {wordSpacingRangeConfig.variant === ThSettingsRangeVariant.numberField ? (
        <StatefulNumberField
          ...
          onReset={
            canBeReset(ThSpacingSettingsKeys.wordSpacing)
        ...
        <StatefulSlider
          standalone={standalone}
          displayTicks={
            wordSpacingRangeConfig.variant ===
