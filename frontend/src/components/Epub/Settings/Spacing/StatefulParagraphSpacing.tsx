...
export const StatefulParagraphSpacing = ({
  standalone = true,
  ...
  const paragraphSpacingRangeConfig = {
    ...
    placeholder:
      preferences.settings.keys[ThSettingsKeys.paragraphSpacing].placeholder,
  ...
  const placeholderText = usePlaceholder(
    paragraphSpacingRangeConfig.placeholder,
    paragraphSpacingRangeConfig.range,
    "multiplier",
  );

  const { getSetting, submitPreferences } = useEpubNavigator();

  const { getEffectiveSpacingValue, setParagraphSpacing, canBeReset } =
    useSpacingPresets();
  ...
  return (
    <>
      {paragraphSpacingRangeConfig.variant ===
      ThSettingsRangeVariant.numberField ? (
        <StatefulNumberField
          ...
          onReset={
            canBeReset(ThSpacingSettingsKeys.paragraphSpacing)
