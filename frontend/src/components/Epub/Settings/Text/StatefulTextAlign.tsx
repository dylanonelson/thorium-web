...
export const StatefulTextAlign = ({
  standalone = true,
  ...
  const items = [
    ...
    },
    {
      ...
      label: isRTL
        ? t("reader.settings.align.right")
        : t("reader.settings.align.left"),
  ...
  const updatePreference = useCallback(
    async (value: string) => {
      const textAlign: TextAlignment | null =
        value === ThTextAlignOptions.publisher
          ? null
          : value === ThTextAlignOptions.start
            ? TextAlignment.start
      ...
      const currentHyphens = getSetting("hyphens") as
        | boolean
        | undefined
        | null;
      ...
      const textAlignValue =
        textAlignSetting === null
          ? ThTextAlignOptions.publisher
          : (textAlignSetting as unknown as ThTextAlignOptions);
