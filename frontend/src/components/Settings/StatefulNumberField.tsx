...
import {
  ThNumberField,
  ThNumberFieldProps,
} from "@/core/Components/Settings/ThNumberField";
...
export interface StatefulNumberFieldProps
  extends Omit<ThNumberFieldProps, "classNames"> {
  standalone?: boolean;
  resetLabel?: string;
  placeholder?: string;
}
      ...
      <ThNumberField
        ...
        compounds={{
          ...
          reset: {
            className: classNames(
              readerSharedUI.icon,
              settingsStyles.readerSettingsResetButton,
            ),
            compounds: {
              tooltipTrigger: {
