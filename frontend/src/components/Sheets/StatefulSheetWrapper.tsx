...
} from "./StatefulPopoverSheet";
import {
  StatefulBottomSheet,
  StatefulBottomSheetProps,
} from "./StatefulBottomSheet";
import {
  StatefulFullScreenSheet,
  StatefulFullScreenSheetProps,
} from "./StatefulFullScreenSheet";
import {
  StatefulDockedSheet,
  StatefulDockedSheetProps,
} from "./StatefulDockedSheet";
...
const componentMap = {
  ...
  [ThSheetTypes.dockedStart]: (props: StatefulDockedSheetProps) => (
    <StatefulDockedSheet {...props} flow={ThDockingKeys.start} />
  ),
  [ThSheetTypes.dockedEnd]: (props: StatefulDockedSheetProps) => (
    <StatefulDockedSheet {...props} flow={ThDockingKeys.end} />
  ),
};
